"use client";
import AdminSidebar from '@/app/components/Sidebar/Admin/AdminSidebar';
      ...
      <header className={DashboardStyles.header}>
        <div className={DashboardStyles.container}>
          ...
          <nav className={DashboardStyles.nav}>
            <Link href="/" className={DashboardStyles.link}>Home</Link>
            <Link href="/services" className={DashboardStyles.link}>Services</Link>
            <Link href="#" className={DashboardStyles.link}>Account</Link>
          </nav>
        </div>
      </header>
      <div className={DashboardStyles.container}>
